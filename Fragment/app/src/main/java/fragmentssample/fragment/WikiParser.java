...
public class WikiParser {
        ...
        public  class  Generateurl {
            ...
            public void GenerateWikiurl() throws IOException, JSONException {
                ...
                InputStream source = httpNetwork.JsonParseGet(httpNetwork.GenerateWikiRequest(message));
                if(source == null)
                {
            ...
            public void GenerateMobileUrl() throws IOException, JSONException {
                ...
                Gson gson = gsonBuilder.create();
                InputStream source = httpNetwork.JsonParseGet(httpNetwork.GenerateMobileNetworkRequest(Pageid));
                if(source == null){
                    Log.e("response from json parsing is : ", source.toString());
                    return;
                }
            ...
            public void GenerateMultipleResultUrl(String title) throws IOException, JSONException {
                ...
                Gson gson = gsonBuilder.create();
                InputStream source = httpNetwork.JsonParseGet(httpNetwork.GenerateMultipleResultNetworkRequest(title));
                if(source == null){
                    Log.e("response from json parsing is : ", source.toString());
                    return;
                }
