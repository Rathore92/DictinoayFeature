...
/**
 * Created by lal.chand on 18/07/14.
 */
public class MobileSerializer implements JsonDeserializer<Pages> {
    ...
    public void setWikiurl(Pages pages,Map.Entry<String, JsonElement> DataEntry){
        if (DataEntry.getValue() != null) {
            pages.getWikiEntity().setFullurl(DataEntry.getValue().toString());
...
//            pages.getWikiEntity().setExtract("No definition found");
    ...
    public  void SetwikiMobileurl (Pages pages,Map.Entry<String, JsonElement> DataEntry ){
        if (DataEntry != null) {
                        ...
                        for (Map.Entry<String, JsonElement> WikiEntry : WEObj.entrySet()) {
                            ...
                            if (DataObj != null) {
                                for (Map.Entry<String, JsonElement> DataEntry : DataObj.entrySet()) {
                                    SetwikiMobileurl(pages, DataEntry);
                                    CheckExtract = true;
                                }
                            }
                        }
